...
void _vehicleSerialize(
  ...
  writer.writeDouble(offsets[2], object.ratePerKm);
}
...
Vehicle _vehicleDeserialize(
  ...
  object.ratePerKm = reader.readDouble(offsets[2]);
  return object;
}
...
extension VehicleQueryFilter
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> ratePerKmEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'ratePerKm',
        value: value,
        epsilon: epsilon,
      ));
    });
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> ratePerKmGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> ratePerKmLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> ratePerKmBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension VehicleQuerySortBy on QueryBuilder<Vehicle, Vehicle, QSortBy> {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> sortByRatePerKm() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ratePerKm', Sort.asc);
    });
  }

  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> sortByRatePerKmDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ratePerKm', Sort.desc);
    });
  }
}
...
extension VehicleQuerySortThenBy
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> thenByRatePerKm() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ratePerKm', Sort.asc);
    });
  }

  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> thenByRatePerKmDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ratePerKm', Sort.desc);
    });
  }
...
extension VehicleQueryWhereDistinct
  ...
  QueryBuilder<Vehicle, Vehicle, QDistinct> distinctByRatePerKm() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'ratePerKm');
    });
  }
}
...
extension VehicleQueryProperty
  ...
  QueryBuilder<Vehicle, double, QQueryOperations> ratePerKmProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'ratePerKm');
    });
  }
}
